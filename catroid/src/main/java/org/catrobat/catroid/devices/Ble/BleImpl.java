 ...
 */
package org.catrobat.catroid.devices.Ble;
...
public class BleImpl implements Arduino {
	...
	private static final String TAG = BleImpl.class.getSimpleName();
